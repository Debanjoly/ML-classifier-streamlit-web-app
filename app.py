...
def main():
    ...
    if st.sidebar.checkbox("Show raw data", False):
        ...
        "or of unknown edibility and not recommended. This latter class was combined with the poisonous one.Here all the columns are categoriacl so level encoding has been done.")
